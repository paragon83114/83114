...
alias ls="lsd" l="lsd -l" ll="lsd -lha" c="clear" nano="nvim" g="glow -w220 -p" oc="opencode -c" v="nvim" f='nvim -c "NvimTreeToggle"' t="lsd -l --tree --depth 2" bye="kill -9 -1" m="music-shuffle" ms="music-select" lg="cd ~/termux && lazygit"
