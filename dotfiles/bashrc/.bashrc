...
alias ls="lsd" l="lsd -l" ll="lsd -lha" c="clear" nano="nvim" oc="opencode -c" v="nvim" f="nvim -c 'Neotree toggle'" t="lsd -l --tree --depth 2" bye="kill -9 -1" m="music-shuffle" ms="music-select" lg="lazygit" h="atuin search -i"
